...
*-------------------------------------------------------------------------------------------*/
import { AfterContentChecked, ChangeDetectorRef, ElementRef, EventEmitter, NgZone, OnChanges, OnDestroy, OnInit, Renderer2, SimpleChanges, TemplateRef, ViewContainerRef } from '@angular/core';
...
export declare class MultiSelectTreeComponent implements OnInit, OnDestroy, OnChanges, AfterContentChecked, DataBoundComponent, ExpandableComponent, ControlValueAccessor {
    ...
    private readonly isTagFocused;
    private readonly isTreeViewActive;
    /**
     * @hidden
     */
    isVisible: any;
    ...
    constructor(popupService: PopupService, renderer: Renderer2, hostElement: ElementRef, navigationService: NavigationService, _zone: NgZone, localization: LocalizationService, cdr: ChangeDetectorRef);
    ngOnInit(): void;
    /**
     * @hidden
     */
