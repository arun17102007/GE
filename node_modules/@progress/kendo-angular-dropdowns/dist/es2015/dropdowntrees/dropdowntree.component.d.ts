...
export declare class DropDownTreeComponent implements OnInit, OnDestroy, OnChanges, AfterContentChecked, ControlValueAccessor, DataBoundComponent, ExpandableComponent {
     ...
     * If set to `true`, the component emits the `filterChange` event, which can be used to [filter the DropDownTree manually]({% slug filtering_dropdowntree %}#toc-manual-filtering).
     * A built-in filtering implementation is available to use with the [`kendoDropDownTreeHierarchyBinding`]({% slug api_dropdowntree_dropdowntreeshierarchybindingdirective %}) and [`kendoDropDownTreeFlatBinding`]({% slug api_dropdowntree_dropdowntreesflatbindingdirective %}) directives.
     */
    filterable: boolean;
    /**
     * @hidden
