...
export declare class MultiSelectComponent implements OnDestroy, OnChanges, OnInit, DoCheck, AfterContentChecked, AfterViewInit, FilterableComponent {
     ...
     */
    checkboxes: MultiSelectCheckableSettings | boolean;
    /**
