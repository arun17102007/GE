...
*-------------------------------------------------------------------------------------------*/
import { AfterContentInit, AfterViewInit, EventEmitter, OnInit, OnDestroy, ElementRef, TemplateRef, Renderer2, ChangeDetectorRef, OnChanges, SimpleChanges, NgZone, QueryList } from '@angular/core';
...
export declare class DialogComponent implements AfterContentInit, AfterViewInit, OnInit, OnChanges, OnDestroy {
    private _elRef;
    private _renderer;
    private cdr;
    private zone;
    ...
    constructor(_elRef: ElementRef, _renderer: Renderer2, localization: LocalizationService, cdr: ChangeDetectorRef, zone: NgZone);
    /**
     * @hidden
     */
