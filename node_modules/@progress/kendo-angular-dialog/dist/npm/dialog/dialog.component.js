...
var DialogComponent = /** @class */ (function () {
    function DialogComponent(_elRef, _renderer, localization, cdr, zone) {
        var _this = this;
        this._elRef = _elRef;
        ...
        if (this.titlebarContent.first) {
            ...
            this.subscriptions.push(this.titlebarContent.changes.subscribe(function () {
                if (util_1.isPresent(_this.titlebarContent.first)) {
                    ...
                    _this.zone.onStable.pipe(operators_1.take(1)).subscribe(function () {
                        _this.bubble('close', _this.titlebarContent.first);
                        _this._renderer.setAttribute(_this._elRef.nativeElement.querySelector('.k-dialog'), 'aria-labelledby', _this.titleId);
                    });
                }
            }));
        }
    ...
    DialogComponent.prototype.ngOnChanges = function (changes) {
        ...
        if (changes.title && changes.title.currentValue && !changes.title.previousValue) {
            this.zone.onStable.pipe(operators_1.take(1)).subscribe(function () {
                _this.bubble('close', _this.titlebarView);
                _this._renderer.setAttribute(_this._elRef.nativeElement.querySelector('.k-dialog'), 'aria-labelledby', _this.titleId);
            });
        }
    };
    ...
    tslib_1.__decorate([
        core_1.ViewChild(dialog_titlebar_component_1.DialogTitleBarComponent, { static: false }),
        tslib_1.__metadata("design:type", dialog_titlebar_component_1.DialogTitleBarComponent)
