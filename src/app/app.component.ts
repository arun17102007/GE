...
@Component({
  ...
  template: `
      <kendo-grid #grid
        ...
        <kendo-grid-column field="Id" editor="numeric" title="Id" format="{formatOptions}"></kendo-grid-column>
        <kendo-grid-column field="Name" title="Name"></kendo-grid-column>
        <kendo-grid-column field="IsComplete" editor="boolean" title="IsComplete"></kendo-grid-column>
